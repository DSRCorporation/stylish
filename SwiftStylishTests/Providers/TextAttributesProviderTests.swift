...
class TextAttributesProviderTests: BaseProviderTests
{
    ...
    func testProviderForSegmentedControl()
    {
        ...
        let fontName1 = (normalAttrs?[NSAttributedString.Key.font] as? UIFont)?.fontName
        let color1 = (normalAttrs?[NSAttributedString.Key.foregroundColor] as? UIColor)
        ...
        let fontName2 = (selectedAttrs?[NSAttributedString.Key.font] as? UIFont)?.fontName
        let color2 = (selectedAttrs?[NSAttributedString.Key.foregroundColor] as? UIColor)
    ...
    func testProviderForNavigationBar()
    {
        ...
        let fontName1 = (normalAttrs1?[NSAttributedString.Key.font] as? UIFont)?.fontName
        let color1 = normalAttrs1?[NSAttributedString.Key.foregroundColor] as? UIColor
        ...
        let fontName2 = (normalAttrs2![NSAttributedString.Key.font] as! UIFont).fontName
        let color2 = (normalAttrs2![NSAttributedString.Key.foregroundColor] as! UIColor)
